...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _line = __webpack_require__(67);
	...
	for (var i = 0; i < lineCount; i++) {
	  lines.push(new _line2.default(canvas, i));
	}
	
	(function loop() {
	  ctx.clearRect(0, 0, canvas.width, canvas.height);
	  for (var _i = 0; _i < lines.length; _i++) {
	    lines[_i].drawDots(ctx);
	    lines[_i].moveDots();
	  }
	...
	eb.onopen = function () {
	  eb.registerHandler('data.updates', function (err, msg) {
	    if (!err) {
	      var w = 10 + Math.round(msg.body / 10000000);
	      if (w > 100) {
	        w = 100;
	      }
	
	      lines[(0, _util.getRandomInt)(0, lineCount - 1)].pushDot(w, (0, _util.getColorForTxValue)(msg.body));
	    }
	  });
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	, __webpack_require__(35)(__webpack_require__(32))
	
	  // polling transports
	, __webpack_require__(43)
	, __webpack_require__(35)(__webpack_require__(43))
	, __webpack_require__(45)
	, __webpack_require__(46)
	, __webpack_require__(35)(__webpack_require__(45))
...
/***/ (function(module, exports) {
	...
	function getColorForTxValue(value) {
	  ...
	  if (btc < 0.1) return hexToRgb("#A7FCA9", 1);else if (btc < 0.25) return hexToRgb("#85FF89", 1);else if (btc < 0.5) return hexToRgb("#4FFF55", 1);else if (btc < 1) return hexToRgb("#AAFF4F", 1);else if (btc < 3) return hexToRgb("#F6FF4F", 1);else if (btc < 5) return hexToRgb("#FFBE4F", 1);else return hexToRgb("#FF4F4F", 1);
	}
	...
	exports.getColorForTxValue = getColorForTxValue;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _dot = __webpack_require__(68);
	...
	var Line = function () {
	  ...
	  _createClass(Line, [{
	    key: 'pushDot',
	    value: function pushDot(width, color) {
	      this.dots.push(new _dot2.default(this.row * -15, this.y, width, color));
	    }
	  }, {
	    key: 'destroyDot',
	    value: function destroyDot(i) {
